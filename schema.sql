...
-- =====================================================================
-- DDL-Skript: Sprachlern-App (PostgreSQL) - Korrigierte Version
-- =====================================================================
...
CREATE INDEX idx_child_profiles_language_id ON child_profiles (language_id); -- KORRIGIERT: language -> language_id
...
CREATE INDEX idx_exercises_language_id ON exercises (language_id); -- KORRIGIERT: language -> language_id
CREATE INDEX idx_exercises_type_id ON exercises (exercise_type_id); -- KORRIGIERT: type -> exercise_type_id
...
CREATE INDEX idx_words_language_id ON words (language_id); -- KORRIGIERT: language -> language_id
...
-- Hinweiskorrektur: Der Primärschlüssel (task_id, word_id) deckt Abfragen auf task_id bereits ab!
...
CREATE INDEX idx_progress_status_id ON learning_progress (status_id); -- KORRIGIERT: status -> status_id
CREATE INDEX idx_progress_child_status ON learning_progress (child_id, status_id); -- KORRIGIERT: status -> status_id
